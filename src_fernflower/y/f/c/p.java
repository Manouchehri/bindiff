...
class p implements Comparator {
   ...
   public int compare(Object var1, Object var2) {
      ...
      int var5 = y.g.e.a(this.a.a[var3.c().d()], this.a.a[var4.c().d()]);
      if(var5 != 0) {
         return var5;
      } else {
         int var6;
         int var8 = this.a.e[var6 = var3.b()];
         int var7;
         int var9 = this.a.e[var7 = var4.b()];
         int var10 = y.g.e.a(var8, var9);
         if(var10 != 0) {
            return var10;
         } else {
            int var11 = this.a.g[var6];
            int var12 = this.a.g[var7];
            if(var11 > 0) {
               ...
               if(var17 != 0) {
                  ...
                  int var18 = y.g.e.a(this.a.f[var6], this.a.f[var7]);
                  if(var18 != 0) {
                     return var18;
                  } else {
                     int var19 = this.a.h[var6];
                     int var20 = this.a.h[var7];
