...
final class cR implements Comparator {
   ...
   public cR(y.f.X var1, aU var2, aV var3) {
      this.b = var1;
      this.a = var3;
      this.c = var2;
   }
   ...
   final float a(y.c.d var1) {
      boolean var5 = N.x;
      y.f.aE var2 = this.a.a(var1).c();
      y.d.t var4 = this.b.n(var1);
      float var3;
      if(var2 == null || var2.g()) {
         var3 = (float)(var4.a / 10000.0D);
         if(!var5) {
            return (float)this.a.a(var1.c()).k() + var3;
         }
      }
   ...
   public int compare(Object var1, Object var2) {
      ...
      byte var5 = this.a.a(var3.d()).b();
      if(var5 == 12 || var5 == 13) {
         boolean var6 = var5 == 12;
         aX var7 = this.a.a(var3.c());
         aX var8 = this.a.a(var4.c());
