...
final class p {
   ...
   public static void a(X var0, y.c.d var1, Collection var2, Collection var3) {
      int var11 = c.a;
      if(var1.e()) {
         if(var2 == null) {
         ...
         label121: {
            ...
            var4 = (ax)((Collection)var2).iterator().next();
         }
         ...
         label115: {
            ...
            var5 = (ax)((Collection)var3).iterator().next();
         }
   ...
   private static boolean a(ax var0, ax var1) {
      return var0.a((int)1) && var1.a((int)1) || var0.a((int)2) && var1.a((int)2) || var0.a((int)4) && var1.a((int)4) || var0.a((int)8) && var1.a((int)8);
   }

   private static ax a(ax var0, int var1) {
      return var0.b()?ax.a(var0.c(), var0.d(), var1, var0.f()):ax.a(var1, var0.f());
   }

   public static Collection a(X var0, y.c.d var1, Collection var2, boolean var3) {
      aE var4;
      t var5;
      label28: {
         if(var3) {
      ...
      if(var4 != null) {
         ...
         if(var4.a()) {
            ...
            var6 = ax.a(var5.a, var5.b, var6.a());
         }
