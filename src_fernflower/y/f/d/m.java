...
final class m {
   ...
   private static double a(y.d.m var0, y.d.m var1) {
   ...
   static double a(y.d.n var0, y.d.t var1) {
      int var7 = a.f;
      if(a(var0)) {
         ...
         while(true) {
            if(var5 < var2.length) {
               y.d.m var6 = new y.d.m(var2[var5], var2[(var5 + 1) % var2.length]);
               var10000 = Math.min(var3, a(var6, var1));
               if(var7 != 0) {
                  break;
               }
   ...
   private static double a(y.d.y var0, y.d.t var1) {
      if(var0.a(var1)) {
         ...
         y.d.m var8 = new y.d.m(var2, var3);
         var6 = Math.min(var6, a(var8, var1));
         y.d.m var9 = new y.d.m(var5, var4);
         var6 = Math.min(var6, a(var9, var1));
         y.d.m var10 = new y.d.m(var2, var5);
         var6 = Math.min(var6, a(var10, var1));
         y.d.m var11 = new y.d.m(var3, var4);
         var6 = Math.min(var6, a(var11, var1));
         return var6;
      }
   }
