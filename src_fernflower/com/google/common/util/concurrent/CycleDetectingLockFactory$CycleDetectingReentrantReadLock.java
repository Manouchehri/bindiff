...
class CycleDetectingLockFactory$CycleDetectingReentrantReadLock extends ReadLock {
   ...
   CycleDetectingLockFactory$CycleDetectingReentrantReadLock(CycleDetectingLockFactory var1, CycleDetectingLockFactory$CycleDetectingReentrantReadWriteLock var2) {
      super(var2);
      this.this$0 = var1;
