...
public final class Monitor {
   ...
   public void enterWhen(Monitor$Guard var1) {
   ...
   public boolean enterIfInterruptibly(Monitor$Guard var1) {
      if(var1.monitor != this) {
         throw new IllegalMonitorStateException();
      } else {
         ReentrantLock var2 = this.lock;
   ...
   public void waitFor(Monitor$Guard var1) {
   ...
   public boolean waitFor(Monitor$Guard var1, long var2, TimeUnit var4) {
      long var5 = toSafeNanos(var2, var4);
      if(!(var1.monitor == this & this.lock.isHeldByCurrentThread())) {
         throw new IllegalMonitorStateException();
   ...
   @GuardedBy("lock")
   private void await(Monitor$Guard var1, boolean var2) {
      if(var2) {
         this.signalNextWaiter();
      }
