...
class Chars$CharArrayAsList extends AbstractList implements Serializable, RandomAccess {
   ...
   Chars$CharArrayAsList(char[] var1) {
      this(var1, 0, var1.length);
   }

   Chars$CharArrayAsList(char[] var1, int var2, int var3) {
      this.array = var1;
      this.start = var2;
      this.end = var3;
   }
   ...
   public Character get(int var1) {
      ...
      return Character.valueOf(this.array[this.start + var1]);
   }

   public boolean contains(Object var1) {
      return var1 instanceof Character && Chars.access$000(this.array, ((Character)var1).charValue(), this.start, this.end) != -1;
   }

   public int indexOf(Object var1) {
      if(var1 instanceof Character) {
         int var2 = Chars.access$000(this.array, ((Character)var1).charValue(), this.start, this.end);
         if(var2 >= 0) {
   ...
   public int lastIndexOf(Object var1) {
      if(var1 instanceof Character) {
         int var2 = Chars.access$100(this.array, ((Character)var1).charValue(), this.start, this.end);
         if(var2 >= 0) {
            return var2 - this.start;
         }
      }
   ...
   public Character set(int var1, Character var2) {
      ...
      this.array[this.start + var1] = ((Character)Preconditions.checkNotNull(var2)).charValue();
