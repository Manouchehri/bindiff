...
public final class UnsignedInteger extends Number implements Comparable {
   ...
   public static UnsignedInteger valueOf(long var0) {
      Preconditions.checkArgument((var0 & 4294967295L) == var0, "value (%s) is outside the range for an unsigned integer value", new Object[]{Long.valueOf(var0)});
      return fromIntBits((int)var0);
   }

   public static UnsignedInteger valueOf(BigInteger var0) {
      Preconditions.checkNotNull(var0);
      Preconditions.checkArgument(var0.signum() >= 0 && var0.bitLength() <= 32, "value (%s) is outside the range for an unsigned integer value", new Object[]{var0});
