...
class Predicates$AndPredicate implements Predicate, Serializable {
   ...
   private Predicates$AndPredicate(List var1) {
   ...
   public String toString() {
      ...
      return (new StringBuilder(16 + String.valueOf(var1).length())).append("Predicates.and(").append(var1).append(")").toString();
   }

   // $FF: synthetic method
   Predicates$AndPredicate(List var1, Predicates$1 var2) {
      this(var1);
   }
}
