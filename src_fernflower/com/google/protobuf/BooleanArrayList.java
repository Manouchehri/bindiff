...
final class BooleanArrayList extends AbstractProtobufList implements Internal$BooleanList, RandomAccess {
   ...
   BooleanArrayList(List var1) {
      if(var1 instanceof BooleanArrayList) {
         ...
         for(int var3 = 0; var3 < this.size; ++var3) {
            this.array[var3] = ((Boolean)var1.get(var3)).booleanValue();
         }
      }
   ...
   public Boolean get(int var1) {
      return Boolean.valueOf(this.getBoolean(var1));
   }
   ...
   public Boolean set(int var1, Boolean var2) {
      return Boolean.valueOf(this.setBoolean(var1, var2.booleanValue()));
   }
   ...
   public void add(int var1, Boolean var2) {
      this.addBoolean(var1, var2.booleanValue());
   }

   public void addBoolean(boolean var1) {
      this.addBoolean(this.size, var1);
   }
   ...
   public boolean remove(Object var1) {
      ...
      for(int var2 = 0; var2 < this.size; ++var2) {
         if(var1.equals(Boolean.valueOf(this.array[var2]))) {
