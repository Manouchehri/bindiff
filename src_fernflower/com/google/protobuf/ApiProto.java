...
public final class ApiProto {
   ...
   static {
      ...
      ApiProto$1 var1 = new ApiProto$1();
      Descriptors$FileDescriptor.internalBuildGeneratedFileFrom(var0, new Descriptors$FileDescriptor[]{SourceContextProto.getDescriptor(), TypeProto.getDescriptor()}, var1);
