...
final class DescriptorProtos$DescriptorProto$ReservedRange$1 extends AbstractParser {
   public DescriptorProtos$DescriptorProto$ReservedRange parsePartialFrom(CodedInputStream var1, ExtensionRegistryLite var2) {
      try {
         return new DescriptorProtos$DescriptorProto$ReservedRange(var1, var2, (DescriptorProtos$1)null);
