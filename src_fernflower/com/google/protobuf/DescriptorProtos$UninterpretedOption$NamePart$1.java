...
final class DescriptorProtos$UninterpretedOption$NamePart$1 extends AbstractParser {
   public DescriptorProtos$UninterpretedOption$NamePart parsePartialFrom(CodedInputStream var1, ExtensionRegistryLite var2) {
      try {
         return new DescriptorProtos$UninterpretedOption$NamePart(var1, var2, (DescriptorProtos$1)null);
