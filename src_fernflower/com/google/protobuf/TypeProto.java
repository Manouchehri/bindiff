...
public final class TypeProto {
   ...
   static {
      ...
      TypeProto$1 var1 = new TypeProto$1();
      Descriptors$FileDescriptor.internalBuildGeneratedFileFrom(var0, new Descriptors$FileDescriptor[]{AnyProto.getDescriptor(), SourceContextProto.getDescriptor()}, var1);
