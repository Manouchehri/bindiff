...
public final class CNodeExitState implements IMouseState {
   ...
   public CNodeExitState(CStateFactory var1, AbstractZyGraph var2, q var3) {
      this.m_factory = var1;
      this.m_graph = var2;
      this.m_node = var3;
   }
   ...
   public IMouseStateChange mouseMoved(MouseEvent var1, AbstractZyGraph var2) {
      ...
      return var7.t()?CHitNodesTransformer.enterNode(this.m_factory, var1, var7):CHitNodesTransformer.exitNode(this.m_factory, var1, var7, this);
   }
