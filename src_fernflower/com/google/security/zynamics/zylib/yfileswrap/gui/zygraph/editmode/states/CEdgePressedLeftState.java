...
public class CEdgePressedLeftState implements IMouseState {
   ...
   public CEdgePressedLeftState(CStateFactory var1, AbstractZyGraph var2, d var3) {
   ...
   public IMouseStateChange mouseReleased(MouseEvent var1, AbstractZyGraph var2) {
      return new CStateChange(this.m_factory.createEdgeClickedLeftState(this.m_edge, var1), true);
   }
}
