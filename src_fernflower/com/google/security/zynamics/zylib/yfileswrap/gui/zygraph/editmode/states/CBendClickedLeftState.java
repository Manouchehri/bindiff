...
public class CBendClickedLeftState implements IMouseState {
   ...
   public CBendClickedLeftState(CStateFactory var1, AbstractZyGraph var2, x var3) {
   ...
   public IMouseStateChange mouseMoved(MouseEvent var1, AbstractZyGraph var2) {
      ...
      if(var7.t()) {
         ...
         return CHitBendsTransformer.changeBend(this.m_factory, var1, var7, this.m_bend);
      } else if(var7.q()) {
         return new CStateChange(this, true);
      } else {
         this.m_factory.createBendExitState(this.m_bend, var1);
