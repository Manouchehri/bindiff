...
public class CEdgePressedRightState implements IMouseState {
   ...
   public CEdgePressedRightState(CStateFactory var1, AbstractZyGraph var2, d var3, MouseEvent var4) {
   ...
   public IMouseStateChange mouseReleased(MouseEvent var1, AbstractZyGraph var2) {
      return new CStateChange(this.m_factory.createEdgeClickedRightState(this.m_edge, var1), true);
   }
}
