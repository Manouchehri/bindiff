...
public class CBackgroundPressedRightState implements IMouseState {
   ...
   public CBackgroundPressedRightState(CStateFactory var1, AbstractZyGraph var2) {
   ...
   public IMouseStateChange mouseDragged(MouseEvent var1, AbstractZyGraph var2) {
      return new CStateChange(this.m_factory.createBackgroundDraggedRightState(var1), true);
   }
   ...
   public IMouseStateChange mouseReleased(MouseEvent var1, AbstractZyGraph var2) {
      return new CStateChange(this.m_factory.createBackgroundClickedRightState(var1), true);
   }
}
