...
public class CombinedEdgeRealizer extends ZyEdgeRealizer {
   ...
   public CombinedEdgeRealizer(ZyLabelContent var1, IEdgeRealizerUpdater var2, GraphSettings var3) {
      super(var1, var2);
      this.settings = (GraphSettings)Preconditions.checkNotNull(var3);
   }
   ...
   public void paintBends(Graphics2D var1) {
      if(this.settings.getDrawBends()) {
         ...
         while(var2.f()) {
            ...
            var1.setColor(var7?SingleEdgeRealizer.BEND_SELECTION_COLOR:Color.WHITE);
