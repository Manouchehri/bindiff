...
public class MouseTreeNodeSelectionHandlerCombinedBasicBlock {
   private static void selectGraphNode(CombinedFlowGraphBasicBlockTreeNode var0) {
      CombinedFlowGraphRootTreeNode var1 = var0.getRootNode();
      CombinedFlowGraphBaseTreeNode var2 = (CombinedFlowGraphBaseTreeNode)var0.getParent();
   ...
   private static void selectGraphNodeCtrl(CombinedFlowGraphBasicBlockTreeNode var0) {
      CombinedFlowGraphRootTreeNode var1 = var0.getRootNode();
      CombinedFlowGraphBaseTreeNode var2 = (CombinedFlowGraphBaseTreeNode)var0.getParent();
      CombinedGraph var3 = var1.getGraph();
      CombinedDiffNode var4 = var0.getCombinedDiffNode();
   ...
   private static void selectGraphNodeCtrlShift(CombinedFlowGraphBasicBlockTreeNode var0) {
      CombinedFlowGraphRootTreeNode var1 = var0.getRootNode();
      CombinedFlowGraphBaseTreeNode var2 = (CombinedFlowGraphBaseTreeNode)var0.getParent();
      CombinedGraph var3 = var1.getGraph();
      CombinedDiffNode var4 = var0.getCombinedDiffNode();
      ...
      if(var7 == null) {
         ...
         for(int var10 = 1; var10 < var2.getChildCount(); ++var10) {
            CombinedFlowGraphBasicBlockTreeNode var11 = (CombinedFlowGraphBasicBlockTreeNode)var2.getChildAt(var10);
   ...
   private static void selectGraphNodeShift(CombinedFlowGraphBasicBlockTreeNode var0) {
      CombinedFlowGraphRootTreeNode var1 = var0.getRootNode();
      CombinedFlowGraphBaseTreeNode var2 = (CombinedFlowGraphBaseTreeNode)var0.getParent();
      CombinedGraph var3 = var1.getGraph();
      CombinedDiffNode var4 = var0.getCombinedDiffNode();
   ...
   public static void handleMouseSelectionEvent(MouseEvent var0, CombinedFlowGraphBasicBlockTreeNode var1) {
