...
public final class MouseTreeNodeSelectionHandlerSingleBasicBlock {
   private static void selectGraphNode(SingleFlowGraphBasicBlockTreeNode var0) {
      SingleFlowGraphRootTreeNode var1 = var0.getRootNode();
      SingleFlowGraphBaseTreeNode var2 = (SingleFlowGraphBaseTreeNode)var0.getParent();
   ...
   private static void selectGraphNodeCtrl(SingleFlowGraphBasicBlockTreeNode var0) {
      SingleFlowGraphRootTreeNode var1 = var0.getRootNode();
      SingleFlowGraphBaseTreeNode var2 = (SingleFlowGraphBaseTreeNode)var0.getParent();
      SingleGraph var3 = var1.getGraph();
      SingleDiffNode var4 = var0.getSingleDiffNode();
   ...
   private static void selectGraphNodeCtrlShift(SingleFlowGraphBasicBlockTreeNode var0) {
      SingleFlowGraphRootTreeNode var1 = var0.getRootNode();
      SingleFlowGraphBaseTreeNode var2 = (SingleFlowGraphBaseTreeNode)var0.getParent();
      SingleGraph var3 = var1.getGraph();
      SingleDiffNode var4 = var0.getSingleDiffNode();
      ...
      if(var7 == null) {
         ...
         for(int var10 = 1; var10 < var2.getChildCount(); ++var10) {
            SingleFlowGraphBasicBlockTreeNode var11 = (SingleFlowGraphBasicBlockTreeNode)var2.getChildAt(var10);
   ...
   private static void selectGraphNodeShift(SingleFlowGraphBasicBlockTreeNode var0) {
      SingleFlowGraphRootTreeNode var1 = var0.getRootNode();
      SingleFlowGraphBaseTreeNode var2 = (SingleFlowGraphBaseTreeNode)var0.getParent();
      SingleGraph var3 = var1.getGraph();
      SingleDiffNode var4 = var0.getSingleDiffNode();
   ...
   public static void handleMouseSelectionEvent(MouseEvent var0, SingleFlowGraphBasicBlockTreeNode var1) {
