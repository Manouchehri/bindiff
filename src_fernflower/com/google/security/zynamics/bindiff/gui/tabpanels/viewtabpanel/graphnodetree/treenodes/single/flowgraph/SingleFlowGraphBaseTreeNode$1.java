...
class SingleFlowGraphBaseTreeNode$1 extends AbstractAction {
   // $FF: synthetic field
   final ESide val$side;
   // $FF: synthetic field
   final SingleFlowGraphBaseTreeNode this$0;

   SingleFlowGraphBaseTreeNode$1(SingleFlowGraphBaseTreeNode var1, String var2, ESide var3) {
      super(var2);
      this.this$0 = var1;
      this.val$side = var3;
   }
   ...
   public void actionPerformed(ActionEvent var1) {
      FlowGraphViewData var2 = (FlowGraphViewData)SingleFlowGraphBaseTreeNode.access$100(this.this$0);
      ClipboardHelpers.copyToClipboard(var2.getAddress(this.val$side).toHexString());
   }
}
