...
public class InitialFlowGraphSettingsDialog extends BaseDialog {
   ...
   public InitialFlowGraphSettingsDialog(Window var1) {
      super(var1, "Initial Flow Graph Settings");
      ...
      this.buttons = new CPanelTwoButtons(new InitialFlowGraphSettingsDialog$InternalButtonListener(this, (InitialFlowGraphSettingsDialog$1)null), "Ok", "Cancel");
      this.init();
      this.pack();
   ...
   private void save() {
      ...
      GraphViewSettingsConfigItem var2 = var1.getInitialFlowgraphSettings();
   ...
   // $FF: synthetic method
   static void access$100(InitialFlowGraphSettingsDialog var0) {
      var0.save();
   }
}
