...
final class BinExport$Flowgraph$Vertex$Instruction$1 extends AbstractParser {
   public BinExport$Flowgraph$Vertex$Instruction parsePartialFrom(CodedInputStream var1, ExtensionRegistryLite var2) {
      try {
         return new BinExport$Flowgraph$Vertex$Instruction(var1, var2, (BinExport$1)null);
