...
public final class BinExport {
   ...
   static {
      ...
      BinExport$1 var1 = new BinExport$1();
      Descriptors$FileDescriptor.internalBuildGeneratedFileFrom(var0, new Descriptors$FileDescriptor[0], var1);
      internal_static_BinExport_Meta_descriptor = (Descriptors$Descriptor)getDescriptor().getMessageTypes().get(0);
      ...
      internal_static_BinExport_Callgraph_descriptor = (Descriptors$Descriptor)getDescriptor().getMessageTypes().get(1);
      ...
      internal_static_BinExport_Flowgraph_descriptor = (Descriptors$Descriptor)getDescriptor().getMessageTypes().get(2);
