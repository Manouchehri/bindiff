...
final class BinExport$Flowgraph$Edge$1 extends AbstractParser {
   public BinExport$Flowgraph$Edge parsePartialFrom(CodedInputStream var1, ExtensionRegistryLite var2) {
      try {
         return new BinExport$Flowgraph$Edge(var1, var2, (BinExport$1)null);
