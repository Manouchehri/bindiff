...
final class BinExport$Flowgraph$Vertex$1 extends AbstractParser {
   public BinExport$Flowgraph$Vertex parsePartialFrom(CodedInputStream var1, ExtensionRegistryLite var2) {
      try {
         return new BinExport$Flowgraph$Vertex(var1, var2, (BinExport$1)null);
