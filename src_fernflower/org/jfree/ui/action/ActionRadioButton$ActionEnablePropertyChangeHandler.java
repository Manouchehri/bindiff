...
class ActionRadioButton$ActionEnablePropertyChangeHandler implements PropertyChangeListener {
   ...
   private ActionRadioButton$ActionEnablePropertyChangeHandler(ActionRadioButton var1) {
      this.this$0 = var1;
   }
   ...
   public void propertyChange(PropertyChangeEvent var1) {
      try {
         ...
         if(var1.getPropertyName().equals("AcceleratorKey")) {
            ...
            if(var4 instanceof KeyStroke && var4 != null) {
   ...
   ActionRadioButton$ActionEnablePropertyChangeHandler(ActionRadioButton var1, ActionRadioButton$1 var2) {
      this(var1);
   }
}
