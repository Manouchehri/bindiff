...
final class MinMaxCategoryRenderer$1 implements Icon {
   ...
   MinMaxCategoryRenderer$1(MinMaxCategoryRenderer var1, GeneralPath var2, Paint var3, Paint var4, int var5, int var6) {
      this.this$0 = var1;
      this.val$path = var2;
      this.val$fillPaint = var3;
      this.val$outlinePaint = var4;
      this.val$width = var5;
   ...
   public void paintIcon(Component var1, Graphics var2, int var3, int var4) {
      ...
      if(this.val$fillPaint != null) {
         var5.setPaint(this.val$fillPaint);
         var5.fill(this.val$path);
      }

      if(this.val$outlinePaint != null) {
         var5.setPaint(this.val$outlinePaint);
