...
public class CombinedRangeXYPlot extends XYPlot implements Serializable, Cloneable, PlotChangeListener, Zoomable, PublicCloneable {
   ...
   public CombinedRangeXYPlot(ValueAxis var1) {
      super((XYDataset)null, (ValueAxis)null, var1, (XYItemRenderer)null);
      this.totalWeight = 0;
      this.gap = 5.0D;
   ...
   public void add(XYPlot var1, int var2) {
      if(var2 <= 0) {
         String var3 = "The \'weight\' must be positive.";
   ...
   protected AxisSpace calculateAxisSpace(Graphics2D var1, Rectangle2D var2) {
      ...
      for(int var14 = 0; var14 < var20; ++var14) {
         ...
         AxisSpace var18 = var15.calculateDomainAxisSpace(var1, this.subplotAreas[var14], (AxisSpace)null);
   ...
   public void zoomDomainAxes(double var1, PlotRenderingInfo var3, Point2D var4) {
      ...
      if(var5 != null) {
         var5.zoomDomainAxes(var1, var3, var4);
      }
   ...
   public void zoomDomainAxes(double var1, double var3, PlotRenderingInfo var5, Point2D var6) {
      ...
      if(var7 != null) {
         var7.zoomDomainAxes(var1, var3, var5, var6);
      }
   ...
   public boolean equals(Object var1) {
      if(var1 == this) {
         return true;
      } else if(!(var1 instanceof CombinedRangeXYPlot)) {
         return false;
      } else if(!super.equals(var1)) {
         return false;
      } else {
         CombinedRangeXYPlot var2 = (CombinedRangeXYPlot)var1;
         return !ObjectUtilities.equal(this.subplots, var2.subplots)?false:(this.totalWeight != var2.totalWeight?false:this.gap == var2.gap);
      }
   }

   public Object clone() {
      CombinedRangeXYPlot var1 = (CombinedRangeXYPlot)super.clone();
