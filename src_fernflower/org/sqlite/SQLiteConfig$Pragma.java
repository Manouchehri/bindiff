...
enum SQLiteConfig$Pragma {
   ...
   private SQLiteConfig$Pragma(String var3) {
      this(var3, (String[])null);
   }

   private SQLiteConfig$Pragma(String var3, String[] var4) {
      this(var3, (String)null, (String[])null);
   }

   private SQLiteConfig$Pragma(String var3, String var4, String[] var5) {
      this.pragmaName = var3;
