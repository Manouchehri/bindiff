...
final class Murmur3_128HashFunction$Murmur3_128Hasher extends AbstractStreamingHashFunction$AbstractStreamingHasher
{
    ...
    Murmur3_128HashFunction$Murmur3_128Hasher(final int n) {
        super(16);
        this.h1 = n;
        this.h2 = n;
        this.length = 0;
    ...
    protected void processRemaining(final ByteBuffer byteBuffer) {
        ...
        switch (byteBuffer.remaining()) {
            case 15: {
                n2 ^= UnsignedBytes.toInt(byteBuffer.get(14)) << 48;
            }
            case 14: {
                n2 ^= UnsignedBytes.toInt(byteBuffer.get(13)) << 40;
            }
            case 13: {
                n2 ^= UnsignedBytes.toInt(byteBuffer.get(12)) << 32;
            }
            case 12: {
                n2 ^= UnsignedBytes.toInt(byteBuffer.get(11)) << 24;
            }
            case 11: {
                n2 ^= UnsignedBytes.toInt(byteBuffer.get(10)) << 16;
            }
            case 10: {
                n2 ^= UnsignedBytes.toInt(byteBuffer.get(9)) << 8;
            }
            case 9: {
            ...
            case 7: {
                n ^= UnsignedBytes.toInt(byteBuffer.get(6)) << 48;
            }
            case 6: {
                n ^= UnsignedBytes.toInt(byteBuffer.get(5)) << 40;
            }
            case 5: {
                n ^= UnsignedBytes.toInt(byteBuffer.get(4)) << 32;
            }
            case 4: {
                n ^= UnsignedBytes.toInt(byteBuffer.get(3)) << 24;
            }
            case 3: {
            ...
            case 1: {
                n3 = (n ^ UnsignedBytes.toInt(byteBuffer.get(0)));
                break;
            }
            default: {
