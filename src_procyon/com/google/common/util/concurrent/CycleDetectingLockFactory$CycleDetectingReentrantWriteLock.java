...
class CycleDetectingLockFactory$CycleDetectingReentrantWriteLock extends WriteLock
{
    ...
    CycleDetectingLockFactory$CycleDetectingReentrantWriteLock(final CycleDetectingLockFactory this$0, final CycleDetectingLockFactory$CycleDetectingReentrantReadWriteLock readWriteLock) {
        this.this$0 = this$0;
        super(readWriteLock);
