...
public final class CacheBuilder
{
    ...
    CacheBuilder setKeyStrength(final LocalCache$Strength localCache$Strength) {
        Preconditions.checkState(this.keyStrength == null, "Key strength was already set to %s", this.keyStrength);
        this.keyStrength = (LocalCache$Strength)Preconditions.checkNotNull(localCache$Strength);
        return this;
    }
    ...
    CacheBuilder setValueStrength(final LocalCache$Strength localCache$Strength) {
        Preconditions.checkState(this.valueStrength == null, "Value strength was already set to %s", this.valueStrength);
        this.valueStrength = (LocalCache$Strength)Preconditions.checkNotNull(localCache$Strength);
        return this;
    }
    ...
    public AsyncLoadingCache build(final AsyncCacheLoader asyncCacheLoader) {
        Preconditions.checkState(this.weigher == null, (Object)"AsyncLoadingCache does not support weigher");
        Preconditions.checkState(this.maximumWeight == -1L, (Object)"AsyncLoadingCache does not support maximumWeight");
        Preconditions.checkState(this.removalListener == null, (Object)"AsyncLoadingCache does not support removalListener");
        Preconditions.checkState(this.keyStrength == null || this.keyStrength == LocalCache$Strength.STRONG, (Object)"AsyncLoadingCache does not support soft or weak keys");
        Preconditions.checkState(this.valueStrength == null || this.valueStrength == LocalCache$Strength.STRONG, (Object)"AsyncLoadingCache does not support soft or weak values");
        return ShimAsyncCache.from(this, asyncCacheLoader);
    }
    ...
    static {
        NULL_STATS_COUNTER = Suppliers.ofInstance(new CacheBuilder$1());
        EMPTY_STATS = new CacheStats(0L, 0L, 0L, 0L, 0L, 0L);
        CACHE_STATS_COUNTER = new CacheBuilder$2();
        NULL_TICKER = new CacheBuilder$3();
