...
class MapMakerInternalMap$WeakEntry extends WeakReference implements MapMakerInternalMap$ReferenceEntry
{
    final int hash;
    final MapMakerInternalMap$ReferenceEntry next;
    volatile MapMakerInternalMap$ValueReference valueReference;
    
    MapMakerInternalMap$WeakEntry(final ReferenceQueue referenceQueue, final Object o, final int hash, @Nullable final MapMakerInternalMap$ReferenceEntry next) {
