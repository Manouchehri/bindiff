...
class Multisets$1$1 extends AbstractIterator
{
    ...
    Multisets$1$1(final Multisets$1 this$0, final Iterator val$iterator1, final Iterator val$iterator2) {
        this.this$0 = this$0;
    ...
    protected Multiset$Entry computeNext() {
        if (this.val$iterator1.hasNext()) {
            ...
            return Multisets.immutableEntry(element, Math.max(multiset$Entry.getCount(), this.this$0.val$multiset2.count(element)));
        }
