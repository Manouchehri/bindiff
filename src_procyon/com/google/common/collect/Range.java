...
public final class Range implements Predicate, Serializable
{
    ...
    @Deprecated
    @GoogleInternal
    public static Range closedOrEmpty(final Comparable comparable, final Comparable comparable2) {
        return (comparable.compareTo(comparable2) > 0) ? closedOpen(comparable, comparable) : closed(comparable, comparable2);
    }
    ...
    static {
        LOWER_BOUND_FN = new Range$1();
        UPPER_BOUND_FN = new Range$2();
        RANGE_LEX_ORDERING = new Range$RangeLexOrdering(null);
