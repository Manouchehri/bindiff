...
final class Platform
{
    ...
    static SortedMap mapsTransformEntriesSortedMap(final SortedMap sortedMap, final Maps$EntryTransformer maps$EntryTransformer) {
        return (sortedMap instanceof NavigableMap) ? Maps.transformEntries((NavigableMap)sortedMap, maps$EntryTransformer) : Maps.transformEntriesIgnoreNavigable(sortedMap, maps$EntryTransformer);
    }
