...
final class MapMakerInternalMap$WeakExpirableEntry extends MapMakerInternalMap$WeakEntry implements MapMakerInternalMap$ReferenceEntry
{
    volatile long time;
    MapMakerInternalMap$ReferenceEntry nextExpirable;
    MapMakerInternalMap$ReferenceEntry previousExpirable;
    
    MapMakerInternalMap$WeakExpirableEntry(final ReferenceQueue referenceQueue, final Object o, final int n, @Nullable final MapMakerInternalMap$ReferenceEntry mapMakerInternalMap$ReferenceEntry) {
