...
public class Colors
{
    public static final Color PRIMARY_BASE;
    public static final Color SECONDARY_BASE;
    public static final Color MATCHED_BASE;
    public static final Color CHANGED_BASE;
    public static final Color MIXED_BASE_COLOR;
    public static final Color INSTRUCTIONS_ONLY_CHANGED_COLOR;
    public static final Color MATCHED_LABEL_BAR;
    public static final Color UNMATCHED_PRIMARY_LABEL_BAR;
    public static final Color UNMATCHED_SECONDARY_LABEL_BAR;
    public static final Color PIE_MATCHED;
    public static final Color PIE_PRIMARY_UNMATCHED;
    public static final Color PIE_SECONDARY_UNMATCHED;
    public static final Color LINECHART_SIMILARITY;
    public static final Color LINECHART_CONFIDENCE;
    public static final Color TABLE_CELL_PRIMARY_DEFAULT_BACKGROUND;
    public static final Color TABLE_CELL_SECONDARY_DEFAULT_BACKGROUND;
    ...
    static {
        PRIMARY_BASE = new Color(245, 210, 210);
        SECONDARY_BASE = new Color(230, 235, 240);
        MATCHED_BASE = new Color(211, 251, 222);
        CHANGED_BASE = new Color(240, 241, 200);
        MIXED_BASE_COLOR = new Color(160, 160, 0);
        INSTRUCTIONS_ONLY_CHANGED_COLOR = new Color(235, 251, 211);
        MATCHED_LABEL_BAR = new Color(176, 213, 176);
        UNMATCHED_PRIMARY_LABEL_BAR = new Color(213, 176, 173);
        UNMATCHED_SECONDARY_LABEL_BAR = new Color(183, 195, 205);
        PIE_MATCHED = new Color(150, 200, 150);
        PIE_PRIMARY_UNMATCHED = new Color(200, 150, 150);
        PIE_SECONDARY_UNMATCHED = new Color(160, 175, 190);
        LINECHART_SIMILARITY = new Color(128, 194, 0);
        LINECHART_CONFIDENCE = new Color(96, 96, 160);
        TABLE_CELL_PRIMARY_DEFAULT_BACKGROUND = new Color(253, 240, 235);
        TABLE_CELL_SECONDARY_DEFAULT_BACKGROUND = new Color(235, 240, 245);
        TABLE_CELL_MATCHEDUSERVIEW_DEFAULT_BACKGROUND = new Color(242, 255, 242);
        TABLE_CELL_MATCHED_BACKGROUND = Colors.MATCHED_LABEL_BAR;
        TABLE_CELL_CHANGED_BACKGROUND = new Color(220, 220, 150);
        TABLE_CELL_PRIMARY_UNMATCHED_BACKGROUND = Colors.UNMATCHED_PRIMARY_LABEL_BAR;
        TABLE_CELL_SECONDARY_UNMATCHED_BACKGROUND = Colors.UNMATCHED_SECONDARY_LABEL_BAR;
