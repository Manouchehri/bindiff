...
class SingleFlowGraphBaseTreeNode$1 extends AbstractAction
{
    ...
    SingleFlowGraphBaseTreeNode$1(final SingleFlowGraphBaseTreeNode this$0, final String s, final ESide val$side) {
        this.this$0 = this$0;
    ...
    public void actionPerformed(final ActionEvent actionEvent) {
        ClipboardHelpers.copyToClipboard(((FlowGraphViewData)this.this$0.getView()).getAddress(this.val$side).toHexString());
    }
}
