...
class CombinedCallGraphBaseTreeNode$4 extends AbstractAction
{
    ...
    CombinedCallGraphBaseTreeNode$4(final CombinedCallGraphBaseTreeNode this$0, final String s) {
        this.this$0 = this$0;
        super(s);
    }
    ...
    public void actionPerformed(final ActionEvent actionEvent) {
        ClipboardHelpers.copyToClipboard(this.this$0.getDiff().getMetaData().getImageHash(ESide.SECONDARY));
    }
}
