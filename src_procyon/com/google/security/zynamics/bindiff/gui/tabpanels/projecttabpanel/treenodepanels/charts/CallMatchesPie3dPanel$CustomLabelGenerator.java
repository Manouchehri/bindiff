...
class CallMatchesPie3dPanel$CustomLabelGenerator implements PieSectionLabelGenerator
{
    ...
    private CallMatchesPie3dPanel$CustomLabelGenerator(final CallMatchesPie3dPanel this$0) {
        this.this$0 = this$0;
    }
    ...
    public String generateSectionLabel(final PieDataset pieDataset, final Comparable comparable) {
        ...
        if (pieDataset != null) {
            ...
            else if (comparable.equals(CallMatchesPie3dPanel.PLOTS[1])) {
                s = String.format("%d\n%.1f%s", this.this$0.primaryUnmatchedCount, this.this$0.primaryUnmatchedPercent, "%");
            }
            else if (comparable.equals(CallMatchesPie3dPanel.PLOTS[2])) {
