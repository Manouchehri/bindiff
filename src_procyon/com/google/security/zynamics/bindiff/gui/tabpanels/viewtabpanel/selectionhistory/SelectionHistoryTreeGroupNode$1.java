...
class SelectionHistoryTreeGroupNode$1 extends AbstractAction
{
    ...
    SelectionHistoryTreeGroupNode$1(final SelectionHistoryTreeGroupNode this$0, final String s) {
        this.this$0 = this$0;
        super(s);
    }
    ...
    public void actionPerformed(final ActionEvent actionEvent) {
        ...
        while (iterator.hasNext()) {
            sb.append(((RawFunction)iterator.next().getRawNode()).getAddress().toHexString());
            sb.append("\n");
        }
