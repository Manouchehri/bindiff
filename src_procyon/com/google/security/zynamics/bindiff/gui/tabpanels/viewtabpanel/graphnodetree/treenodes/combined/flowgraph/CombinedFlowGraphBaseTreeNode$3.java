...
class CombinedFlowGraphBaseTreeNode$3 extends AbstractAction
{
    ...
    CombinedFlowGraphBaseTreeNode$3(final CombinedFlowGraphBaseTreeNode this$0, final String s) {
        this.this$0 = this$0;
        super(s);
    }
    ...
    public void actionPerformed(final ActionEvent actionEvent) {
        ClipboardHelpers.copyToClipboard(((FlowGraphViewData)this.this$0.getView()).getAddress(ESide.SECONDARY).toHexString());
    }
}
