...
class SelectionHistoryTreeGroupNode$6 extends AbstractAction
{
    final /* synthetic */ SelectionHistoryTreeGroupNode this$0;
    
    SelectionHistoryTreeGroupNode$6(final SelectionHistoryTreeGroupNode this$0, final String s) {
        this.this$0 = this$0;
        super(s);
    }
    ...
    public void actionPerformed(final ActionEvent actionEvent) {
        ...
        while (iterator.hasNext()) {
            final RawFunction rawFunction = (RawFunction)iterator.next().getPrimaryRawNode();
            if (rawFunction != null) {
