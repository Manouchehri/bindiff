...
class SelectionHistoryTreeGroupNode$8 extends AbstractAction
{
    ...
    SelectionHistoryTreeGroupNode$8(final SelectionHistoryTreeGroupNode this$0, final String s) {
        this.this$0 = this$0;
        super(s);
    }
    ...
    public void actionPerformed(final ActionEvent actionEvent) {
        ...
        while (iterator.hasNext()) {
            final RawBasicBlock rawBasicBlock = (RawBasicBlock)iterator.next().getPrimaryRawNode();
