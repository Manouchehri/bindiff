...
class SingleCallGraphBaseTreeNode$3 extends AbstractAction
{
    ...
    SingleCallGraphBaseTreeNode$3(final SingleCallGraphBaseTreeNode this$0, final String s, final ESide val$side) {
        this.this$0 = this$0;
    ...
    public void actionPerformed(final ActionEvent actionEvent) {
        ClipboardHelpers.copyToClipboard(this.this$0.getDiff().getMetaData().getIdbName(this.val$side));
    }
}
