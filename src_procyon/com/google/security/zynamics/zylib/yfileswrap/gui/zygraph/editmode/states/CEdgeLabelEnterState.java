...
public class CEdgeLabelEnterState implements IMouseState
{
    ...
    public CEdgeLabelEnterState(final CStateFactory cStateFactory, final AbstractZyGraph abstractZyGraph, final aA aa) {
    ...
    public IMouseStateChange mouseMoved(final MouseEvent mouseEvent, final AbstractZyGraph abstractZyGraph) {
        ...
        return new CStateChange(this.m_factory.createEdgeLabelExitState(this.m_label, mouseEvent), true);
    }
