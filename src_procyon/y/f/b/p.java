...
final class p
{
    ...
    public static void a(final X x, final d d, Collection list, Collection list2) {
        ...
        if (a(ax, ax2)) {
            final boolean[] a2 = a(ax.a());
            final boolean[] a3 = a(ax2.a());
            Label_0396: {
                Label_0279: {
                    if (b(a2) > b(a3)) {
                        int i = 0;
                            ...
                            while (i < a3.length) {
                                ...
                                if (a == 0) {
                                    ...
                                    if (b2 == 0) {
                                        int j = 0;
                                        while (j < a3.length) {
                                            final boolean b3 = a3[j];
                                            if (a != 0) {
                                                return;
                                            }
                                            if (b3) {
                                                final int n = (a3.length + j - 1) % a3.length;
                                                a2[n] = true;
                                                a3[n] = false;
                                                if (a == 0) {
                                                    break;
                ...
                while (true) {
                    while (k < a2.length) {
                        final int b5;
                        final boolean b4 = (b5 = (a2[k] ? 1 : 0)) != 0;
                        if (a == 0) {
                            if (b4 && a3[k]) {
                                a3[k] = false;
                            }
                            ...
                            if (b5 == 0) {
                                int l = 0;
                                while (l < a2.length) {
                                    final boolean b6 = a2[l];
                                    if (a != 0) {
                                        return;
                                    }
                                    if (b6) {
                                        final int n2 = (l + 1) % a2.length;
                                        a3[n2] = true;
                                        a2[n2] = false;
                                        if (a == 0) {
                                            break;
