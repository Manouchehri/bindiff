...
extends JDialog {
    ...
    public AboutDialog(String string, ProjectInfo projectInfo) {
        this.init(string, projectInfo.getName(), new StringBuffer().append("Version ").append(projectInfo.getVersion()).toString(), projectInfo.getInfo(), projectInfo.getLogo(), projectInfo.getCopyright(), projectInfo.getLicenceText(), projectInfo.getContributors(), projectInfo);
    }

    public AboutDialog(Frame frame, String string, ProjectInfo projectInfo) {
        super(frame);
        this.init(string, projectInfo.getName(), new StringBuffer().append("Version ").append(projectInfo.getVersion()).toString(), projectInfo.getInfo(), projectInfo.getLogo(), projectInfo.getCopyright(), projectInfo.getLicenceText(), projectInfo.getContributors(), projectInfo);
    }

    public AboutDialog(Dialog dialog, String string, ProjectInfo projectInfo) {
        super(dialog);
        this.init(string, projectInfo.getName(), new StringBuffer().append("Version ").append(projectInfo.getVersion()).toString(), projectInfo.getInfo(), projectInfo.getLogo(), projectInfo.getCopyright(), projectInfo.getLicenceText(), projectInfo.getContributors(), projectInfo);
    }

    private void init(String string, String string2, String string3, String string4, Image image, String string5, String string6, List list, ProjectInfo projectInfo) {
