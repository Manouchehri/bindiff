...
public enum Field$Kind implements ProtocolMessageEnum
{
    ...
    public static Field$Kind valueOf(int n2) {
        switch (n2) {
            case 0: {
                return TYPE_UNKNOWN;
            }
    ...
    public final Descriptors$EnumValueDescriptor getValueDescriptor() {
        return (Descriptors$EnumValueDescriptor)Field$Kind.getDescriptor().getValues().get(this.index);
    }
    ...
    public static Field$Kind valueOf(Descriptors$EnumValueDescriptor descriptors$EnumValueDescriptor) {
        if (descriptors$EnumValueDescriptor.getType() != Field$Kind.getDescriptor()) {
    ...
    private Field$Kind(int n3, int n4) {
        this.index = n3;
        this.value = n4;
    }
