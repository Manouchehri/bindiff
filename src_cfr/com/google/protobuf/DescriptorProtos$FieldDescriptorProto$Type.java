...
public enum DescriptorProtos$FieldDescriptorProto$Type implements ProtocolMessageEnum
{
    ...
    public static DescriptorProtos$FieldDescriptorProto$Type valueOf(int n2) {
        switch (n2) {
            case 1: {
                return TYPE_DOUBLE;
            }
    ...
    public final Descriptors$EnumValueDescriptor getValueDescriptor() {
        return (Descriptors$EnumValueDescriptor)DescriptorProtos$FieldDescriptorProto$Type.getDescriptor().getValues().get(this.index);
    }
    ...
    public static DescriptorProtos$FieldDescriptorProto$Type valueOf(Descriptors$EnumValueDescriptor descriptors$EnumValueDescriptor) {
        if (descriptors$EnumValueDescriptor.getType() == DescriptorProtos$FieldDescriptorProto$Type.getDescriptor()) return VALUES[descriptors$EnumValueDescriptor.getIndex()];
        throw new IllegalArgumentException("EnumValueDescriptor is not for this type.");
    }

    private DescriptorProtos$FieldDescriptorProto$Type(int n3, int n4) {
        this.index = n3;
        this.value = n4;
    }
