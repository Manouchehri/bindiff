...
public class CBackgroundPressedLeftState
implements IMouseState {
    private final CStateFactory m_factory;
    private final AbstractZyGraph m_graph;

    public CBackgroundPressedLeftState(CStateFactory cStateFactory, AbstractZyGraph abstractZyGraph) {
    ...
    public IMouseStateChange mouseDragged(MouseEvent mouseEvent, AbstractZyGraph abstractZyGraph) {
        return new CStateChange(this.m_factory.createBackgroundDraggedLeftState(mouseEvent), true);
    }
    ...
    public IMouseStateChange mouseReleased(MouseEvent mouseEvent, AbstractZyGraph abstractZyGraph) {
        return new CStateChange(this.m_factory.createBackgroundClickedLeftState(mouseEvent), true);
    }
}
