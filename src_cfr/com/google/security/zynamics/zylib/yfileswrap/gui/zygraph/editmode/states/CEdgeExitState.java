...
public class CEdgeExitState
implements IMouseState {
    private final CStateFactory m_factory;
    private final AbstractZyGraph m_graph;
    private final d m_edge;

    public CEdgeExitState(CStateFactory cStateFactory, AbstractZyGraph abstractZyGraph, d d2) {
    ...
    public IMouseStateChange mouseMoved(MouseEvent mouseEvent, AbstractZyGraph abstractZyGraph) {
        ...
        if (!cW2.u()) return CHitEdgesTransformer.exitEdge(this.m_factory, mouseEvent, cW2, this);
