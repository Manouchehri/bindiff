...
public class CBendEnterState
implements IMouseState {
    private final CStateFactory m_factory;
    private final AbstractZyGraph m_graph;
    private final x m_bend;

    public CBendEnterState(CStateFactory cStateFactory, AbstractZyGraph abstractZyGraph, x x2) {
        ...
        this.m_bend = (x)Preconditions.checkNotNull(x2, "Error: b argument can not be null");
    }
    ...
    public IMouseStateChange mouseMoved(MouseEvent mouseEvent, AbstractZyGraph abstractZyGraph) {
        ...
        if (!cW2.q()) return new CStateChange(this.m_factory.createBendExitState(this.m_bend, mouseEvent), true);
