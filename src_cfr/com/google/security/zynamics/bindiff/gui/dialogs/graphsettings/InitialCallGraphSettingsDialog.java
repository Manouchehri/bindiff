...
public class InitialCallGraphSettingsDialog
extends BaseDialog {
    private static final int DIALOG_WIDTH = 630;
    private static final int DIALOG_HEIGHT = 282;
    private final LayoutingPanel layoutingPanel = new LayoutingPanel("Layouting", ESettingsDialogType.INITIAL_CALLGRAPH_SETTING);
    private final ProximityBrowsingPanel proximityBrowsingPanel = new ProximityBrowsingPanel("Proximity Browsing", ESettingsDialogType.INITIAL_CALLGRAPH_SETTING);
    private final EdgesPanel edgesPanel = new EdgesPanel("Edges", ESettingsDialogType.INITIAL_CALLGRAPH_SETTING);
    private final HierarchicalLayoutPanel hierarchicalLayoutPanel = new HierarchicalLayoutPanel("Hierarchical Layout", ESettingsDialogType.INITIAL_CALLGRAPH_SETTING);
    private final OrthogonalLayoutPanel orthogonalLayoutPanel = new OrthogonalLayoutPanel("Orthogonal Layout", ESettingsDialogType.INITIAL_CALLGRAPH_SETTING);
    private final CircularLayoutPanel circularLayoutPanel = new CircularLayoutPanel("Circular Layout", ESettingsDialogType.INITIAL_CALLGRAPH_SETTING);
    private final ControlsPanel controlsPanel = new ControlsPanel("Controls", ESettingsDialogType.INITIAL_CALLGRAPH_SETTING);
    private final MiscPanel miscPanel = new MiscPanel("Miscellaneous", ESettingsDialogType.INITIAL_CALLGRAPH_SETTING);
    private final CPanelTwoButtons buttons;

    public InitialCallGraphSettingsDialog(Window window) {
    ...
    private void save() {
        ...
        GraphViewSettingsConfigItem graphViewSettingsConfigItem = binDiffConfigFile.getInitialCallgraphSettings();
        ...
        graphViewSettingsConfigItem.setVisibilityWarningThreshold(this.proximityBrowsingPanel.getVisibilityWarningThreshold());
    ...
    static /* synthetic */ void access$100(InitialCallGraphSettingsDialog initialCallGraphSettingsDialog) {
        initialCallGraphSettingsDialog.save();
    }
}
