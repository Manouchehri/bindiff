...
public class FunctionTreeNodeNameComparator
implements Comparator {
    private final ESortOrder order;

    public FunctionTreeNodeNameComparator(ESortOrder eSortOrder) {
    ...
    public int compare(ISortableTreeNode iSortableTreeNode, ISortableTreeNode iSortableTreeNode2) {
        int n2 = 0;
        n2 = iSortableTreeNode.getFunctionName().compareTo(iSortableTreeNode2.getFunctionName());
