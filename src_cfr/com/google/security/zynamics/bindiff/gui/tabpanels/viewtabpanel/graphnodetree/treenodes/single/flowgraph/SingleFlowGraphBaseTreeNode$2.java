...
class SingleFlowGraphBaseTreeNode$2
extends AbstractAction {
    final /* synthetic */ ESide val$side;
    final /* synthetic */ SingleFlowGraphBaseTreeNode this$0;

    SingleFlowGraphBaseTreeNode$2(SingleFlowGraphBaseTreeNode singleFlowGraphBaseTreeNode, String string, ESide eSide) {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        FlowGraphViewData flowGraphViewData = (FlowGraphViewData)SingleFlowGraphBaseTreeNode.access$200(this.this$0);
        ClipboardHelpers.copyToClipboard(flowGraphViewData.getFunctionName(this.val$side));
    }
}
