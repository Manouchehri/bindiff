...
class CombinedCallGraphBaseTreeNode$4
extends AbstractAction {
    final /* synthetic */ CombinedCallGraphBaseTreeNode this$0;

    CombinedCallGraphBaseTreeNode$4(CombinedCallGraphBaseTreeNode combinedCallGraphBaseTreeNode, String string) {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        String string = CombinedCallGraphBaseTreeNode.access$300(this.this$0).getMetaData().getImageHash(ESide.SECONDARY);
