...
class SingleCallGraphBaseTreeNode$3
extends AbstractAction {
    final /* synthetic */ ESide val$side;
    final /* synthetic */ SingleCallGraphBaseTreeNode this$0;

    SingleCallGraphBaseTreeNode$3(SingleCallGraphBaseTreeNode singleCallGraphBaseTreeNode, String string, ESide eSide) {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        String string = SingleCallGraphBaseTreeNode.access$200(this.this$0).getMetaData().getIdbName(this.val$side);
