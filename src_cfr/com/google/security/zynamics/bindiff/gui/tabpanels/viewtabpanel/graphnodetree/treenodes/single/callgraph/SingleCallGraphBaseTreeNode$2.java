...
class SingleCallGraphBaseTreeNode$2
extends AbstractAction {
    final /* synthetic */ ESide val$side;
    final /* synthetic */ SingleCallGraphBaseTreeNode this$0;

    SingleCallGraphBaseTreeNode$2(SingleCallGraphBaseTreeNode singleCallGraphBaseTreeNode, String string, ESide eSide) {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        String string = SingleCallGraphBaseTreeNode.access$100(this.this$0).getMetaData().getImageName(this.val$side);
