...
class CombinedCallGraphBaseTreeNode$2
extends AbstractAction {
    final /* synthetic */ CombinedCallGraphBaseTreeNode this$0;

    CombinedCallGraphBaseTreeNode$2(CombinedCallGraphBaseTreeNode combinedCallGraphBaseTreeNode, String string) {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        String string = CombinedCallGraphBaseTreeNode.access$100(this.this$0).getMetaData().getImageName(ESide.SECONDARY);
