...
public class CombinedEdgeRealizer
extends ZyEdgeRealizer {
    private final GraphSettings settings;

    public CombinedEdgeRealizer(ZyLabelContent zyLabelContent, IEdgeRealizerUpdater iEdgeRealizerUpdater, GraphSettings graphSettings) {
    ...
    public void paintBends(Graphics2D graphics2D) {
        ...
        while (y2.f()) {
            ...
            graphics2D.setColor(bl2 ? SingleEdgeRealizer.BEND_SELECTION_COLOR : Color.WHITE);
