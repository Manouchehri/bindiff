...
public class InstructionCommentDelimiterLineObject
extends AbstractEditableLineObject {
    ...
    public InstructionCommentDelimiterLineObject(RawInstruction rawInstruction, ECommentPlacement eCommentPlacement, int n2, int n3) {
        super(n2, n3);
