...
final class MapMakerInternalMap$EntryFactory$7
extends MapMakerInternalMap$EntryFactory {
    MapMakerInternalMap$EntryFactory$7(String string2, int n3) {
    ...
    MapMakerInternalMap$ReferenceEntry newEntry(MapMakerInternalMap$Segment mapMakerInternalMap$Segment, Object object, int n2, @Nullable MapMakerInternalMap$ReferenceEntry mapMakerInternalMap$ReferenceEntry) {
        return new MapMakerInternalMap$WeakEvictableEntry(mapMakerInternalMap$Segment.keyReferenceQueue, object, n2, mapMakerInternalMap$ReferenceEntry);
    }
