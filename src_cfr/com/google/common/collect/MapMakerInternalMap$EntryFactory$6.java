...
import com.google.common.collect.MapMakerInternalMap$WeakExpirableEntry;
import java.lang.ref.ReferenceQueue;
import javax.annotation.Nullable;

final class MapMakerInternalMap$EntryFactory$6
extends MapMakerInternalMap$EntryFactory {
    MapMakerInternalMap$EntryFactory$6(String string2, int n3) {
    ...
    MapMakerInternalMap$ReferenceEntry newEntry(MapMakerInternalMap$Segment mapMakerInternalMap$Segment, Object object, int n2, @Nullable MapMakerInternalMap$ReferenceEntry mapMakerInternalMap$ReferenceEntry) {
        return new MapMakerInternalMap$WeakExpirableEntry(mapMakerInternalMap$Segment.keyReferenceQueue, object, n2, mapMakerInternalMap$ReferenceEntry);
    }
