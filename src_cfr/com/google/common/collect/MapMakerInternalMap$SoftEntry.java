...
implements MapMakerInternalMap$ReferenceEntry {
    ...
    MapMakerInternalMap$SoftEntry(ReferenceQueue referenceQueue, Object object, int n2, @Nullable MapMakerInternalMap$ReferenceEntry mapMakerInternalMap$ReferenceEntry) {
