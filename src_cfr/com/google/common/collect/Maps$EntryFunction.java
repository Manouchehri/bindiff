...
extends Enum
implements Function {
    public static final /* enum */ Maps$EntryFunction KEY = new Maps$EntryFunction$1("KEY", 0);
    public static final /* enum */ Maps$EntryFunction VALUE = new Maps$EntryFunction$2("VALUE", 1);
    ...
    public static Maps$EntryFunction valueOf(String string) {
        return (Maps$EntryFunction)Enum.valueOf(Maps$EntryFunction.class, string);
    }
     ...
     */
    /* synthetic */ Maps$EntryFunction(Maps$1 var1) {
    ...
    static {
        $VALUES = new Maps$EntryFunction[]{KEY, VALUE};
    }
}
