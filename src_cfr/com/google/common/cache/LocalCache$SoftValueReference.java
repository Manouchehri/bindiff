...
implements LocalCache$ValueReference {
    ...
    LocalCache$SoftValueReference(ReferenceQueue referenceQueue, Object object, LocalCache$ReferenceEntry localCache$ReferenceEntry) {
    ...
    public LocalCache$ValueReference copyFor(ReferenceQueue referenceQueue, Object object, LocalCache$ReferenceEntry localCache$ReferenceEntry) {
        return new LocalCache$SoftValueReference(referenceQueue, object, localCache$ReferenceEntry);
    }
