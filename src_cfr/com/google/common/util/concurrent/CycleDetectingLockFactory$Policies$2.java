...
extends CycleDetectingLockFactory$Policies {
    CycleDetectingLockFactory$Policies$2(String string2, int n3) {
    ...
    public void handlePotentialDeadlock(CycleDetectingLockFactory$PotentialDeadlockException cycleDetectingLockFactory$PotentialDeadlockException) {
        CycleDetectingLockFactory.access$100().log(Level.SEVERE, "Detected potential deadlock", cycleDetectingLockFactory$PotentialDeadlockException);
    }
}
