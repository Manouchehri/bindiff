...
final class BinExport$Callgraph$1
extends AbstractParser {
    BinExport$Callgraph$1() {
    }

    @Override
    public BinExport$Callgraph parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        try {
