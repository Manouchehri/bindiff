...
class hB {
    ...
    static double a(y y2, n n2) {
        if (hB.a(n2)) {
            return hB.a(y2, hB.b(n2));
        }
        if (!n.a(n2, y2, 0.001)) return hB.a(y2, n.a(n2));
        return 0.0;
    }
    ...
    static double a(y y2, y y3) {
        ...
        double d2 = hB.a(y2, y3, false);
        double d3 = hB.a(y2, y3, true);
    ...
    static double a(m m2, m m3) {
        ...
        double d2 = hB.a(m2, m3.c());
        d2 = Math.min(d2, hB.a(m2, m3.d()));
        d2 = Math.min(d2, hB.a(m3, m2.c()));
        return Math.min(d2, hB.a(m3, m2.d()));
    }
    ...
    private static double a(y y2, t[] arrt) {
        ...
        block0 : do {
            ...
            for (int i2 = 0; i2 < arrm.length; ++i2) {
                d2 = Math.min(d2, hB.a(m2, arrm[i2]));
