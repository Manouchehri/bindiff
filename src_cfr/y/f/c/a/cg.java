...
implements Comparator {
    ...
    final float a(d d2) {
        float f2;
        boolean bl2 = N.x;
        aE aE2 = this.a.a(d2).e();
        t t2 = this.b.o(d2);
        if (aE2 == null || aE2.g()) {
            f2 = (float)(t2.a / 10000.0);
            if (!bl2) return (float)this.a.a(d2.d()).k() + f2;
        }
        switch (aE2.b()) {
            case 4: {
        ...
        f2 = (float)(t2.a / 10000.0);
        return (float)this.a.a(d2.d()).k() + f2;
    }

    public int compare(Object object, Object object2) {
        d d2 = (d)object;
        d d3 = (d)object2;
        byte by2 = this.a.a(d2.c()).b();
        if (by2 != 12) {
            if (by2 != 13) return e.a(this.a(d2), this.a(d3));
        }
        boolean bl2 = by2 == 12;
        aX aX2 = this.a.a(d2.d());
        aX aX3 = this.a.a(d3.d());
